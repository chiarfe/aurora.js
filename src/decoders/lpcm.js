...
(function() {
  ...
  LPCMDecoder = (function(_super) {
    ...
    LPCMDecoder.prototype.readChunk = function() {
      var chunkSize, floor, i, littleEndian, output, samples, stream, _i, _j, _k, _l, _m, _n;
      stream = this.stream;
      ...
      if (samples % this.format.channelsPerFrame !== 0) {
        floor = Math.floor(samples / this.format.channelsPerFrame);
        samples = (floor + 1) * this.format.channelsPerFrame;
      }
