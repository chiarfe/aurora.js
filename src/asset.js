...
(function() {
  var Asset, BufferSource, Decoder, Demuxer, EventEmitter, FileSource, HTTPSource, StreamSource,
  ...
  Asset = (function(_super) {
    ...
    Asset.fromStream = function(stream, size) {
    ...
    Asset.prototype.findDecoder = function(format) {
      ...
      if (this.format.floatingPoint) {
        ...
        this.decoder.on('data', (function(_this) {
          return function(buffer) {
            var buf, i, sample, _i, _j, _len, _len1;
            buf = new Float32Array(buffer.length);
            if (_this.format.bitsPerChannel === 8) {
